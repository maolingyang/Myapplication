...
public class SplashActivity extends Activity {
	...
	private void createShortcut() {
		...
		//设置快捷方式图标 需要一个bitmap对象
		intent.putExtra(Intent.EXTRA_SHORTCUT_ICON,BitmapFactory.decodeResource(getResources(),R.drawable.ic_launcher));
		intent.putExtra(Intent.EXTRA_SHORTCUT_NAME,packageInfo.applicationInfo.loadLabel(packageManager));
		Intent homeintent = new Intent();
		homeintent.setAction("com.itheima.shortcut");
		...
		*//**
		...
		shortcut_intent.setAction("com.itheima.shortcut");
	...
	public void copyDb(String dbName) {
		...
		if (file.exists()) {
			...
			try {
				...
				System.out.println("数据库" + dbName + "拷贝完成!");   
			} catch (IOException e) {
				e.printStackTrace();
			} finally {
				if (in != null) {
